...
$(function() {
	...
	$('.other-page .to_login').on('click', 'a', () => {
		toPage({
			url: 'login',
			data: {
				flag: flag,
	...
	$('.other-main .to_login').on('click', 'a', () => {
		toPage({
			url: 'login',
			data: {
				flag: flag,
	...
	let phone_holder = '',
		...
		comfirm_holder = ''
	if (flag == 1) {
		phone_holder = 'input phone';
		code_holder = 'input code';
		email_holder = 'input email';
		birth_holder = 'select birth';
		password_holder = 'input password';
		comfirm_holder = 'input confirm passowrd';
	} else {
		phone_holder = '输入手机';
		code_holder = '输入验证码';
		email_holder = '输入邮箱';
		birth_holder = '选择生日';
		password_holder = '输入密码';
		comfirm_holder = '输入确认密码';
	}
	$('.other-page .r_phone').attr('placeholder', phone_holder);
	$('.other-page .r_code').attr('placeholder', code_holder);
	$('.other-page .r_mail').attr('placeholder', email_holder);
	$('.other-page .birth-time').attr('placeholder', birth_holder);
	$('.other-page .pwd').attr('placeholder', password_holder);
	$('.other-page .rpwd').attr('placeholder', comfirm_holder);

	$('.other-main .r_phone').attr('placeholder', phone_holder);
	$('.other-main .r_code').attr('placeholder', code_holder);
	$('.other-main .r_mail').attr('placeholder', email_holder);
	$('.other-main .birth-time').attr('placeholder', birth_holder);
	$('.other-main .pwd').attr('placeholder', password_holder);
	$('.other-main .rpwd').attr('placeholder', comfirm_holder);
})
